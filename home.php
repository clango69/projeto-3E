...
<head>
    ...
    <link href="https://googleapis.com/css2?family=Space+Grotesk:wght@400;500;700&family=Plus+Jakarta+Sans:wght@400;500;600;700&display=swap" rel="stylesheet">
    ...
    <main class="container portal-layout">
        <section class="hero-block">
            ...
            <div class="dashboard-preview">
                ...
                <div class="stat-box">
                    <span class="num">Rede</span>
                    <span class="label">Pública</span>
                </div>
                <div class="stat-box">
                    <span class="num">Escopo</span>
                    <span class="label">MVP 1.0</span>
                </div>
            </div>
        </section>
            ...
            <div class="track-list">
                <div class="track-card">
                    ...
                    <div class="track-info">
                        <h4>Lógica & Exatas</h4>
                        <p>Desmistificando equações, frações e geometria básica sem decoreba.</p>
                    </div>
                </div>
                <div class="track-card">
                    <div class="track-icon lang"><i class="ph ph-textbox"></i></div>
                    <div class="track-info">
                        <h4>Escrita & Crítica</h4>
                        <p>Estruturação de redações nota mil e técnicas avançadas de interpretação.</p>
                    </div>
                </div>
                <div class="track-card">
                    ...
                    <div class="track-info">
                        ...
                        <p>O universo da física, química e biologia aplicados de forma visual.</p>
                    </div>
                </div>
            </div>
        </section>
